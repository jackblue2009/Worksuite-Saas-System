...
class CompanyController extends AccountBaseController
{
    ...
    // public function storeMyCompany(Request $request) {
    //     $myCompany = new Company();
    //     $myCompany->company_name = 'Neighborhood Cat';
    //     $myCompany->company_email = 'jack99blue2008@gmail.com';
    //     $myCompany->company_phone = '17334088';
    //     $myCompany->timezone = 'Asia/Bahrain';
    //     $myCompany->save();

    //     $myUser = new User();
    //     $myUser->name = 'Jack Blue';
    //     $myUser->email = 'jack99blue2008@gmail.com';
    //     $myUser->company_id = $myCompany->id;

    //     $myUserAuth = UserAuth::create([
    //         'email' => $myUser->email,
    //         'password' => bcrypt('123456@Test'),
    //     ]);
    //     $myUser->user_auth_id = $myUserAuth->id;
    //     $myUser->save();

    //     $adminRole = Role::where('name', 'admin')->where('company_id', $myCompany->id)->first();
    //     if ($adminRole) {
    //         $myUser->roles()->attach($adminRole);
    //     }
    ...
    public function show($id)
    {
        ...
        $this->currency = GlobalCurrency::where('id', $this->latestInvoice->currency_id)->first();
