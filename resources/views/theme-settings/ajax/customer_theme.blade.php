...
<!-- Primary Color Selection for Admin Panel -->
<div class="col-lg-6">
...
<div class="col-lg-6">
    <div class="form-group my-3">
        <x-forms.label fieldId="colorselector" fieldRequired="true" :fieldLabel="__('modules.themeSettings.textColor')">
        </x-forms.label>
        <x-forms.input-group class="color-picker">
            <input type="text" class="form-control height-35 f-14 text_color" value="{{ $adminTheme->text_color }}" placeholder="{{ __('placeholders.colorPicker') }}" name="text_color[]">
