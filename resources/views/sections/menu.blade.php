...
<!-- NAV ITEM - FINANCE COLLAPASE MENU -->
    ...
    @endif
<!-- NAV ITEM - ACCOUNTANT COLLAPASE MENU -->
@if (in_array('accounts', user_modules()) && $sidebarUserPermissions['view_accounts'] != 5 && $sidebarUserPermissions['view_accounts'] != 'none')
    <x-menu-item icon="book" :text="__('app.menu.accountant')" :link="route('accounts.index')">
        <x-slot name="iconPath">
            <path d="M4 .5a.5.5 0 0 0-1 0V1H2a2 2 0 0 0-2 2v1h16V3a2 2 0 0 0-2-2h-1V.5a.5.5 0 0 0-1 0V1H4V.5zM16 7V5H0v5h16a2 2 0 0 0 2-2V7h-2zm3 2V7h-1v2a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1zm-9 3v-2H4v2h6zM3 9.465l.615-.52c1-.833 1.272-1.054 1.785-1.054H8V7H3v2.465z"/>
        </x-slot>
        <x-sub-menu-item :nav-active="request()->is('account/chart-of-accounts*')" :route="route('account.chart-of-accounts.index')" icon="fa fa-circle-o">
            <x-slot name="title">
                @lang('app.menu.chartOfAccounts')
            </x-slot>
        </x-sub-menu-item>
    </x-menu-item>
@endif
