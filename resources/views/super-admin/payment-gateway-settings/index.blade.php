                        ...
                        <ul class="nav -primary" id="nav-tab" role="tablist">
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 paypal" data-toggle="tab"
                                   ...
                                   aria-selected="true"><i class="fab fa-paypal f-12"></i> @lang('app.paypal') <i
                                        class="fa fa-circle ml-1 {{ $credentials->paypal_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 stripe" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=stripe" role="tab"
                                   aria-controls="nav-stripe" aria-selected="false"><i
                                        class="fab fa-stripe-s f-12"></i> @lang('app.stripe') <i
                                        class="fa fa-circle ml-1 {{ $credentials->stripe_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 razorpay" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=razorpay" role="tab"
                                   aria-controls="nav-razorpay" aria-selected="false"><img style="height: 15px;"
                                                                                           src="{{ asset('img/razorpay.png') }}"> @lang('app.razorpay') <i
                                        class="fa fa-circle ml-1 {{ $credentials->razorpay_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 paystack" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=paystack" role="tab"
                                   aria-controls="nav-paystack" aria-selected="false"><img style="height: 15px;"
                                                                                           src="{{ asset('img/paystack.jpg') }}"> @lang('app.paystack') <i
                                        class="fa fa-circle ml-1 {{ $credentials->paystack_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 mollie" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=mollie" role="tab"
                                   aria-controls="nav-mollie" aria-selected="false"><img style="height: 20px;"
                                                                                         src="{{ asset('img/mollie.png') }}"> @lang('app.mollie') <i
                                        class="fa fa-circle ml-1 {{ $credentials->mollie_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
                            <li>
                                <a class="nav-item nav-link f-15 payfast" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=payfast" role="tab"
                                   aria-controls="nav-payfast" aria-selected="false"><img style="height: 15px;"
                                                                                          src="{{ asset('img/payfast.png') }}"> @lang('app.payfast') <i
                                        class="fa fa-circle ml-1 {{ $credentials->payfast_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>

                            <li>
                                <a class="nav-item nav-link f-15 authorize" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=authorize" role="tab"
                                   aria-controls="nav-authorize" aria-selected="false"><img style="height: 15px;"
                                                                                            src="{{ asset('img/authorize.png') }}"> @lang('app.authorize') <i
                                        class="fa fa-circle ml-1 {{ $credentials->authorize_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 square" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=square" role="tab"
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 flutterwave" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=flutterwave" role="tab"
                            ...
                            <li>
                                <a class="nav-item nav-link f-15 offline" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=offline" role="tab"
...
@push('scripts')
    ...
    <script>
        ...
        $('body').on('click', '.edit-type', function () {
            ...
            let url = "{{ route('superadmin.settings.global-offline-payment-setting.edit', ':id') }}";
        ...
        $('body').on('click', '.addMethod', function () {
            const url = "{{ route('superadmin.settings.global-offline-payment-setting.create') }}";
            $(MODAL_LG + ' ' + MODAL_HEADING).html('...');
            $.ajaxModal(MODAL_LG, url);
        ...
        $('body').on('click', '.delete-type', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    let url = "{{ route('superadmin.settings.global-offline-payment-setting.destroy', ':id') }}";
