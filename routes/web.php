...
Route::group(['middleware' => ['auth', 'multi-company-select', 'email_verified'], 'prefix' => 'account'], function () {
    ...
    Route::get('leave-report/leave-quota/{id}', [LeaveReportController::class, 'employeeLeaveQuota'])->name('leave-report.employee-leave-quota');
    ...
    // Currency Settings
    Route::post('/currency-settings/fetch-exchange-rate', 'CurrencySettingController@fetchExchangeRate')->name('currency-settings.fetch-exchange-rate');
});
